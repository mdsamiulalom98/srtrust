    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('proCampaign.update') }}" method="POST" class=row data-parsley-validate=""
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="datetime-local"
                                        class="form-control flatdate @error('date') is-invalid @enderror" name="date"
                                        value="{{ $edit_data->date }}" id="date" required="">
                                    @error('date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('shippingfee') is-invalid @enderror"
                                        name="shippingfee" value="{{ $edit_data->shippingfee }}" id="shippingfee"
                                        required="">
                                    @error('shippingfee')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <select
                                        class="form-control select2-multiple @error('product_ids[]') is-invalid @enderror"
                                        ...
                                        @foreach ($products as $value)
                                            <option value="{{ $value->id }}"
                                                @foreach ($select_products as $select_product) {{ $select_product->id == $value->id ? 'selected' : '' }} @endforeach>
                                                {{ Str::limit($value->name, 8) }}</option>
                                        @endforeach
                                    </select>
                                    @error('product_ids[]')
                                        <span class="invalid-feedback" role="alert">
