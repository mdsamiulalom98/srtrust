                    ...
                    <form action="{{ route('customer.ordersave') }}" method="POST" data-parsley-validate="">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h6 class = "check-position">আপনার অর্ডারটি কনফার্ম করতে তথ্যগুলো পূরণ করে <strong>"অর্ডার করুন"</strong> বাটন এ ক্লিক করুন অথবা ফোনে অর্ডার করতে এই নাম্বার <strong>{{$contact->hotline}}</strong> এর উপরে ক্লিক করুন।
                                    </h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                        ...
                        <div class="card-body cartlist">
                            <table class="cart_table table table-bordered table-striped text-center mb-0">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th colspan="3" class="text-end px-4">ছাড়</th>
                                        <td class="px-4">
                                            <span id="cart_shipping_cost"><span>৳
