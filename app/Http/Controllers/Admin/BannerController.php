...
class BannerController extends Controller
{
    ...
    {
        $categoriess = BannerCategory::orderBy('id','DESC')->select('id','name')->get();
        return view('backEnd.banner.create',compact('categoriess'));
    }
    ...
    public function edit($id)
    {
        ...
        $categoriess = BannerCategory::select('id','name')->get();
        return view('backEnd.banner.edit',compact('edit_data','categoriess'));
    }
